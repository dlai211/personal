...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP and dragging:
            ...
            if col < 3 and row < 3 and piece_exists(game_pieces, {'size': dragged_size, 'player': 1, 'position': (row, col)}):
                # Handle piece placement logic and game state updates here...
                if dragged_size == 3 and player_pieces[2] > 0:
                    ...
                    print(f"Piece placed by player -> Row: {row}, Col: {col}, Size: 3")
